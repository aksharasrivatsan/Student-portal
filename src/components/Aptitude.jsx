    ...
    <div className="bg-white rounded-2xl shadow-sm p-4 lg:p-6">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
        ...
        <div className="mt-4 lg:mt-0 space-y-4">
          <ScoreRow label="Aptitude" value="8/10" />
          <ScoreRow label="Core" value="7/10" />
          <ScoreRow label="Verbal" value="9/10" />
          <ScoreRow label="Programming" value="6/10" />
          <ScoreRow label="Comprehension" value="8/10" />
